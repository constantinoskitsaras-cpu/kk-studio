...
export const projects: Project[] = [
  {
    ...
    vimeoId: '',
    heroImage: '/images/work/aston-martin-db11/aston-martin-db11-07.png',
    heroAspect: 'cinematic',
    images: [
      '/images/work/aston-martin-db11/aston-martin-db11-06.png',
      '/images/work/aston-martin-db11/aston-martin-db11-05.png',
      '/images/work/aston-martin-db11/aston-martin-db11-04.png',
      '/images/work/aston-martin-db11/aston-martin-db11-03.png',
      '/images/work/aston-martin-db11/aston-martin-db11-02.png',
      '/images/work/aston-martin-db11/aston-martin-db11-01.png',
    ],
    featured: true,
    featuredOrder: 1,
  },
